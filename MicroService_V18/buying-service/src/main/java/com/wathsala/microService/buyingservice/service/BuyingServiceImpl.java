...
import com.wathsala.microService.buyingservice.hystrix.CommonHystrixCommad;
import com.wathsala.microService.buyingservice.hystrix.ItemCommand;
...
public class BuyingServiceImpl implements BuyingService{
    ...
    private Company getCompany(int companyId) throws ExecutionException, InterruptedException {

        CommonHystrixCommad<Company> companyCommonHystrixCommad = new CommonHystrixCommad<Company>(setter,()->{
            return restTemplate.getForObject("http://company/services/companies/"+companyId,Company.class);
            },()->{
            return new Company(); }
            );

        Future<Company> companyFuture = companyCommonHystrixCommad.queue();
